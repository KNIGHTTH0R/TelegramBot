...
def _send_cinema(telegram_bot, chat_id, cinema_id, movie_id, d):
        ...
        try:
            ...
            if 'callback_query' in payload:
                ...
                if not cmd:
                    ...
                    _send_cinema(telegram_bot, chat_id, cinema_id, movie_id, d)
                ...
                _send_cinema(telegram_bot, chat_id, cinema_id, movie_id,
                             settings.TODAY)
